...
for(let i = 0; i<365; i++){
  ...
  window.addEventListener("scroll", ()=>{
    ...
    jobTitles[0].style.transform = `translate(calc(200vh - ${offsetY}px))`
    jobTitles[1].style.transform = `translate(calc(-300vh + ${offsetY}px))`
    projectsTitle.style.transform = `translate(calc(400vh - ${offsetY}px))`
    laptop[0].style.transform = `translate(calc(450vh - ${offsetY}px))`
    laptop[1].style.transform = `translate(calc(575vh - ${offsetY}px))`
})